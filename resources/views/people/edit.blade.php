...
<div class="container mt-5">
    ...
    <form action="{{ route('peoples.update', $people->id) }}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto">
        ...
        <div class="mb-4">
            ...
            @if($people->avatar)
            <div class="mt-2">
                <img src="{{ asset('storage/' . $people->avatar) }}" alt="Avatar" class="w-32 h-32 object-cover">
            </div>
            @else
            <div class="mt-2">
                <img src="{{ asset('storage/avatars/user.png') }}" alt="Default Avatar" class="w-32 h-32 object-cover">
            </div>
            @endif
        </div>
        <!-- <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="birth_place" id="birth_place" value="{{ $people->birth_place }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="birth_place">
        </div>
        <div class="mb-4">
            <label for="death_place" class="block text-gray-700 font-bold mb-2">Death place</label>
            <input type="text" name="death_place" id="death_place" value="{{ $people->death_place }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="death place">
        </div>
